...
<PopupWithForm isOpen={false} onClose={closeAllPopups} name='delete' title='Вы уверены?' button='Да'></PopupWithForm>
<PopupWithForm isOpen={isEditAvatarPopupOpen} onClose={closeAllPopups} name='change-avatar' title='Обновить аватар' button='Сохранить'>
  <input
            type="url"
            name="link"
